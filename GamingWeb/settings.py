"""
Django settings for GamingWeb project.
...
ALLOWED_HOSTS = ['gameweb.azurewebsites.net', '127.0.0.1']

CSRF_TRUSTED_ORIGINS = ['https://gameweb.azurewebsites.net']
...
WSGI_APPLICATION = 'GamingWeb.wsgi.application'
